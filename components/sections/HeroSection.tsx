      ...
      <section className="relative min-h-[85vh] flex items-center hero-grid overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Right: Stats Grid — Fade In Right with staggered cards */}
            <div className="grid grid-cols-2 gap-4">
              {stats.map((s, i) => (
                <ScrollReveal key={i} direction="right" delay={i * 100}>
                  <div className="glass rounded-xl p-5 border border-white/5 hover:border-white/20 hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(0,0,0,0.3)] transition-all duration-300 group">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {features.map((f, i) => (
            <ScrollReveal key={i} direction="up" delay={i * 150}>
              <Link
                href={f.href}
                className="glass rounded-xl p-7 text-left border border-white/5 hover:border-white/20 hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(0,0,0,0.3)] transition-all duration-300 group block"
              >
